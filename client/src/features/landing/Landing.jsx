...
import { Shield, Eye, AlertTriangle, Lock, Chrome, TrendingUp, Check, X } from 'lucide-react';
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-cyber-dark">
      {/* Navigation */}
      <nav className="border-b border-gray-800 bg-cyber-darker/50 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-slide-up">
            <h1 className="text-6xl font-bold leading-tight">
              ...
              <span className="text-cyber-red">Compromised</span>.{' '}
      ...
      {/* Live Threat Ticker */}
      <section className="border-y border-gray-800 bg-cyber-darker/30 py-4 overflow-hidden">
        <div className="flex space-x-8 animate-marquee whitespace-nowrap">
          {[...threats, ...threats].map((threat, i) => (
            <div key={i} className="flex items-center space-x-2 text-cyber-red font-mono">
              ...
              {[
                ...
                <tr key={i} className="border-b border-gray-800">
                  ...
                  <td className="text-center py-4 px-4">
                    {pg ? <Check className="w-5 h-5 text-cyber-green mx-auto" /> : <X className="w-5 h-5 text-gray-600 mx-auto" />}
                  </td>
                  <td className="text-center py-4 px-4">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="card-hover">
            <div className="text-sm text-cyber-teal font-semibold mb-2">FREE</div>
          ...
          <div className="card-hover border-cyber-teal">
            <div className="text-sm text-cyber-teal font-semibold mb-2">PREMIUM</div>
            <div className="text-4xl font-bold mb-4">$9<span className="text-lg text-gray-400">/month</span></div>
            <ul className="space-y-3 mb-6">
              {['Everything in Free', 'Unlimited trackers', 'Monthly reports & PDF export', 'Email breach monitoring', 'Priority support', 'Advanced analytics'].map((item, i) => (
                <li key={i} className="flex items-center space-x-2">
                  <Check className="w-5 h-5 text-cyber-teal" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-800 bg-cyber-darker py-12">
